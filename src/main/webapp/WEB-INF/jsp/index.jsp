...
<body>
            ...
            <div class="row row-cols-lg-3 align-items-center">
                ...
                <div class="col">
                    <div class="header-logo justify-content-center">
                        <a href="index.html"><img src="/assets/images/logo/SIDMOOL_logo.png" alt="Learts Logo"></a>
                    </div>
                </div>
                <!-- Header Logo End -->
    ...
    <div class="home1-slider swiper-container">
        <div class="swiper-wrapper">
            <div class="home1-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-image="assets/images/slider/home1/sidmool_main.jpg">
                <div class="home1-slide1-content">
                    ...
                    <h2 class="title">Sidmool Shop</h2>
                    <h3 class="sub-title">Just for you</h3>
                    <div class="link"><a href="shop.html">shop now</a></div>
                </div>
            </div>
            <div class="home1-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-image="assets/images/slider/home1/sidmool_main2.jpg">
            ...
            <div class="home1-slide-item swiper-slide" data-swiper-autoplay="5000" data-bg-image="assets/images/slider/home1/sidmool_main3.jpg">
    ...
    <div class="section section-padding">
        <div class="container">
            ...
            <div class="section-title text-center">
                <h3 class="sub-title">Just for you</h3>
                <h2 class="title title-icon-both">Skin&MakeUp</h2>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row learts-mb-n40">
                ...
                <div class="col-lg-6 col-md-6 col-12 learts-mb-40">
                    <div class="sale-banner2">
                        <div class="inner">
                            <div class="image"><img src="assets/images/banner/sale/sidmool_packge.jpg" alt=""></div>
            ...
            <div class="category-banner1-carousel">
                ...
                <div class="col">
                    <div class="category-banner1">
                        <div class="inner">
                            <a href="shop.html" class="image"><img src="assets/images/banner/category/function.png" alt=""></a>
                            <div class="content">
                                <h3 class="title">
                                    <a href="shop.html">기능별</a>
                ...
                <div class="col">
                    <div class="category-banner1">
                        <div class="inner">
                            <a href="shop.html" class="image"><img src="assets/images/banner/category/ingredient.png" alt=""></a>
                            <div class="content">
                                <h3 class="title">
                                    <a href="shop.html">성분라인별</a>
                                    <span class="number">16</span>
                                </h3>
                            </div>
                        </div>
                ...
                <div class="col">
                    <div class="category-banner1">
                        <div class="inner">
                            <a href="shop.html" class="image"><img src="assets/images/banner/category/question.png" alt=""></a>
                            <div class="content">
                                <h3 class="title">
                                    <a href="shop.html">고민별</a>
            ...
            <div class="products row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                ...
                                <img src="assets/images/product/s328/product_1.jpg" alt="Product Image">
                            </a>
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_2.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            ...
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_3.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                ...
                                <img src="assets/images/product/s328/product_4.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_5.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_6.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">스킨소스 햄프씨드 오일 </a></h6>
                            <span class="price">
                                ₩ 12,800
                            </span>
                            <div class="product-buttons">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                ...
                                <img src="assets/images/product/s328/product_7.jpg" alt="Product Image"></a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">민중기 EGF 앰플</a></h6>
                            <span class="price">
                                ₩ 82,200
                            </span>
                            <div class="product-buttons">
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                ...
                                <img src="assets/images/product/s328/product_8.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">프리미엄 호호바 오일</a></h6>
                            <span class="price">
                                ₩ 16,300
                            </span>
                            <div class="product-buttons">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_9.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">아토로션 </a></h6>
                            <span class="price">
                                ₩ 7,800
                            </span>
                            <div class="product-buttons">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_10.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">스킨소스 D-판테놀 앰플</a></h6>
                            <span class="price">
                                ₩ 9,800
                            </span>
                            <div class="product-buttons">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_11.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">민중기 무기자차 썬크림</a></h6>
                            <span class="price">
                                 ₩ 16,400
                            </span>
                            <div class="product-buttons">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_12.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">닥터트럽 마일드 토너 </a></h6>
                            <span class="price">
                                ₩ 15,800
                            </span>
                            <div class="product-buttons">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_13.jpg" alt="Product Image">
                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">[루페올] 가지 앰플 50ml/</a></h6>
                            <span class="price">
                            	<span class="old">₩ 22,800</span>
                            	<span class="new">₩ 14,800</span>
                            </span>
                            <div class="product-buttons">
                                <a href="#quickViewModal" data-toggle="modal" class="product-button hintT-top" data-hint="Quick View"><i class="fal fa-search"></i></a>
                                <a href="#" class="product-button hintT-top" data-hint="Add to Cart"><i class="fal fa-shopping-cart"></i></a>
                    ...
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                ...
                                <img src="assets/images/product/s328/product_14.jpg" alt="Product Image">
                                                          </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">헤어 테라피 </a></h6>
                            <span class="price">
                                ₩ 14,800
                            </span>
                            <div class="product-buttons">
                ...
                <div class="col">
                    <div class="product">
                        <div class="product-thumb">
                            <a href="product-details.html" class="image">
                                <img src="assets/images/product/s328/product_15.jpg" alt="Product Image">
                                                            </a>
                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                        </div>
                        <div class="product-info">
                            <h6 class="title"><a href="product-details.html">호호바 립 에센스오리지날 고보습</a></h6>
                            <span class="price">
                                ₩ 3,800
                            </span>
                            <div class="product-buttons">
